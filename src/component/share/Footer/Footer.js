  ...
  return (
    <div className='py-5'>
     <Container>
      ...
      <div className='-mt-8'>
      <h3 className='text-3xl font-bold'>Skill Share</h3>
      <p>+92 305 9552222</p>
      <p>contract@skillshare.com</p>
      <p className='text-lg'>Copyright © 2022 - All right reserved || Developed By SHOUROV HASAN</p>
      </div>
    </div>  
        </Col>
    ...
    <span className="footerh">Social</span> 
